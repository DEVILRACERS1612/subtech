        ...
        <div class="container">
                ...
                <div class="align-items-center">
                    <a href="https://subtech.in/contact" class="btn btn-care d-inline-flex align-items-center">
                        <img src="https://subtech.in/images/customer_care.png" alt="Customer Care"
                            class="h-8 w-8 object-contain rounded-lg hover:scale-110 transition-transform duration-200 cursor-pointer"
                            style="cursor:pointer;    height: 1.4rem; margin-right:10px"
                            data-testid="img-customer-care">
            ...
            <div class="footer-top-wrap">
                ...
                <ul class="tf-social-icon style-large">
                    ...
                    <li>
                        <a href="https://www.instagram.com/subtech.in/" class="social-item social-instagram"
                            target="_blank">
                            <i class="icon icon-instagram"></i>
                        </a>
                    </li>
                    <li>
                        <a href="https://linkedin.com/company/subtech-in/" class="social-item social-linkedin"
                            target="_blank"><i class="icon icon-linkedin"></i></a>
                    </li>
                    <li>
                        <a href="https://www.youtube.com/@subtech.e" class="social-item social-youtube"
    ...
    <div class="footer-bottom">
        <div class="container">
            <div class="footer-bottom-wrap">
                <p class="text-light">Copyright © 2025 <span class="fw-medium"></span> Managed By <b>S S Power
                        System</b></p>
                <ul class="tf-payment">
