        ...
        <footer id="footer" class="footer-default xl-pb-70 mt-5">
            <div class="footer-top">
                <div class="container">
                    ...
                    <h2 class="title text-white" style="font-size:3rem">Automate. Protect. Perform</h2>
                    ...
                    <a href="https://subtech.in/contact" class="btn btn-care d-inline-flex align-items-center">
                        <img src="https://subtech.in/images/customer_care.png" alt="Customer Care" class="h-8 w-8 object-contain rounded-lg hover:scale-110 transition-transform duration-200 cursor-pointer" style="cursor:pointer;    height: 1.4rem; margin-right:10px" data-testid="img-customer-care">
                        <span style="font-size:1rem" class="text-white"> Let's Talk</span>
                    </a>
                </div>
                </div>
                    ...
                    <div class="footer-top-wrap">
                        <div class="footer-logo">
                            <a href="./">
                                <img src="<?=BASE_PATH?>images/subtech_footer_logo.png" class="logo" alt="subtech logo white">
                            </a>
                        </div>
                        <ul class="tf-social-icon style-large">
                            <li>
                                <a href="https://www.facebook.com/subtech.in" class="social-item social-facebook" target="_blank">
                                    <i class="icon icon-fb"></i>
                                </a>
                            </li>
                            <li>
                                <a href="https://www.instagram.com/subtech.in/" class="social-item social-instagram" target="_blank">
                                    <i class="icon icon-instagram"></i>
                                </a>
                            </li>
                            <li>
                                <a href="https://linkedin.com/company/subtech-in/" class="social-item social-linkedin" target="_blank"><i
                                        class="icon icon-linkedin"></i></a>
                            </li>
							  <li>
                                <a href="https://www.youtube.com/@subtech.e" class="social-item social-youtube" target="_blank"><i
                                        class="icon icon-youtube"></i></a>
                            </li>
                            <li>
                                <a href="https://x.com/Subteche" class="social-item social-x" target="_blank">
                ...
                <div class="container">
                    <div class="row-footer">
                        <div class="footer-col-block s1">
                            <div class="footer-heading footer-heading-mobile text-xl-2 fw-bold">
                                Business Contact
                            </div>
                                ...
                                <div class="footer-contact">
                                    <ul class="footer-info">
                                        ...
                                        <li class="item">
                                            ...
                                            <a href="tel:085060 60582">085060 60582</a>
                                        </li>
                                        <li class="item">
                                            <span class="box-icon">
                                                <svg width="14" height="14" viewBox="0 0 14 14" fill="none"
                                            ...
                                            <a href="">support@subtech.in</a>
                                        </li>
                                    </ul>
                                    <a href="https://www.google.com/maps/place/Subtech/data=!4m2!3m1!1s0x0:0xa16e659d4bff04f?sa=X&ved=1t:2428&ictx=111"
                                        class="tf-btn btn-line-dark fw-normal ">
                                        <span class="text-sm text-transform-none text-white">
                                            Get directions
                                        </span>
                        ...
                        <div class="footer-inner-wrap footer-col-block s2">
                            ...
                            <div class="tf-collapse-content">
                                <div class="footer-newsletter">
                                    <p>
                                        We invite you to register to read the latest product launch, offers and events about
                                        our company. We promise not spam your inbox.
                                    </p>
    <form id="subsform" class="form-newsletter subscribe-form" accept-charset="utf-8"
        data-mailchimp="true">
    ...
    <input type="hidden" name="method" value="Subscribe" />
        ...
        <div id="smsg"></div>
            <div class="button-submit">
                <button class="subscribe-button animate-btn" type="submit" id="sbtn">
                    <svg width="18" height="18" viewBox="0 0 18 18" fill="none"
                        ...
                        <div class="footer-inner-wrap s3">
                            <div class="footer-col-block inner-col">
                                <div class="footer-heading footer-heading-mobile text-xl-2 fw-bold">About Us</div>
                                <div class="tf-collapse-content">
                                    <ul class="footer-menu-list">
                                        <li>
                                            <a href="<?=BASE_PATH?>about">About Us</a>
                                        </li>
                                        <li>
                                        ...
                                        <li>
                                            <a href="<?=BASE_PATH?>jobs">Career</a>
                                        </li>
										 <li><a href="<?=BASE_PATH?>dealer-locator">Dealer
                                                    Locator</a></li>
                            ...
                            <div class="footer-col-block inner-col">
                                <div class="footer-heading footer-heading-mobile text-xl-2 fw-bold">Useful Links</div>
                                <div class="tf-collapse-content">
                                    <ul class="footer-menu-list">
                                        <li>
										...
										<li>
                                            <a href="<?=BASE_PATH?>solutions">Solutions</a>
                                        </li>
										
                                        <li>
                                            <a href="<?=BASE_PATH?>customer-care">Warranty</a>
                                        </li>
                                       
										<li><a href="<?=BASE_PATH?>customer-care">Grievance</a></li>
            ...
            <div class="footer-bottom">
                <div class="container">
                    <div class="footer-bottom-wrap">
                        <p class="text-light">Copyright © 2025  <span class="fw-medium"></span> Managed By <b>S S Power System</b></p>
                        <ul class="tf-payment">
                           
                           
                            <li class="item"><a href="<?=BASE_PATH?>term-and-condition">Terms</a></li>
							 <li class="item"><a href="<?=BASE_PATH?>privacy-policy">Privacy & Policy</a></li>
							  <li class="item"><a href="<?=BASE_PATH?>privacy-policy">Disclaimer</a></li>
							  <li class="item"><a href="<?=BASE_PATH?>return-policy">Return Policy</a></li>
