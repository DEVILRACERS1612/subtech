...
<body>
    ...
    <div id="wrapper">
	 ...
	 <section class="blog-header-section">
		<div class="container">
			<h1 class="blog-main-title">Our Latest Blog Posts on Technology & Automation</h1>
			<p class="blog-subtitle">Your Trusted Partner in Subtech Solutions for Cutting-Edge Technology and Power Control Innovations</p>
		</div>
	 </section>
