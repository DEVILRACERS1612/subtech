                ...
                <div class="container">
                    <div class="footer-top-wrap">
                        ...
                        <ul class="tf-social-icon style-large">
                            <li>
                                <a href="https://www.facebook.com/subtech.e" class="social-item social-facebook">
                                    <i class="icon icon-fb"></i>
                                </a>
                            </li>
                            <li>
                                <a href="https://www.instagram.com/subtech.e/" class="social-item social-instagram">
                                    <i class="icon icon-instagram"></i>
                                </a>
                            </li>
                            <li>
                                <a href="https://linkedin.com/company/subtech-e/" class="social-item social-linkedin"><i
                                        class="icon icon-linkedin"></i></a>
                            </li>
							  <li>
                                <a href="https://www.youtube.com/@subtech.e" class="social-item social-youtube"><i
                                        class="icon icon-youtube"></i></a>
                            </li>
                            <li>
                                <a href="https://x.com/Subteche" class="social-item social-x">
                ...
                <button class="subscribe-button animate-btn" type="submit" id="sbtn">
                    <svg width="18" height="18" viewBox="0 0 18 18" fill="none"
                        ...
                        <div class="footer-inner-wrap s3">
                            ...
                            <div class="footer-col-block inner-col">
                                <div class="footer-heading footer-heading-mobile text-xl fw-medium">Useful Links</div>
                                <div class="tf-collapse-content">
                                    <ul class="footer-menu-list">
                                        <li>
                                        ...
                                        <li>
                                            <a href="<?=BASE_PATH?>claim-your-warranty">Warranty</a>
                                        </li>
                                        <li>
                                            <a href="<?=BASE_PATH?>news-media">News & Media</a>
                                        </li>
										<li><a href="<?=BASE_PATH?>complains">Grievance</a></li>
            ...
            <div class="footer-bottom">
                <div class="container">
                    <div class="footer-bottom-wrap">
                        <p class="text-dark">Copyright © 2025  <span class="fw-medium">Subtech.</span> All Rights
                            Reserved.</p>
                        <ul class="tf-payment">
