...
$sql=$db->exeQuery("select * from am_rawmaterial where id='".$edit_id."' and am_status='Yes'");
$row=$sql->fetch_assoc();
...
<html lang="en">
<head>
<title>ADD/EDIT Raw Material </title>
				...
				<div class="page-content">
					...
					<div class="row">
						<div class="col-sm-12">
							<div class="card-box">
								<div class="card-head">
									<header>Raw Material Information</header>
								...
								<div class="card-body " id="bar-parent2">
									...
									<div class="col-md-12 col-sm-6">
										<div class="form-group">
											...
											<input type="text" class="form-control" name="rname" value="<?php echo $row['rname'];?>" />
									...
									<div class="col-md-1 col-sm-6">
										<div class="form-group">
											...
											if($row['image']!='')
											{
												echo '<img id="upload1" src="'.BASE_PATH.'images/rawmat/'.$row['image'].'" class="img-responsive" />';
											}else{
...
$(document).ready(function(){
	$("#act-form").on("submit",function(e){
		...
		$("#preloader").show();
		$.ajax({
			url:'<?php echo BASE_PATH;?>Controller/RAW/',
			type:'post',
			...
			success:function(data){
				...
				if(response.type=="success")
				{
					...
					setTimeout(function(){window.location='<?php echo BASE_PATH;?>All_raw/';},500);
				}
				else
				{
					$("#msg").html(response.message);
