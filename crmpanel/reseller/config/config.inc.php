...
{
	//define("BASE_PATH","/april2019/vani/reseller/");
	define("BASE_PATH","/crmpanel/reseller/");
	define("WEB_PATH","/crmpanel/");
	define("COMPANY_PATH","/crmpanel/crm/");
	define("IMG_PATH",BASE_PATH."funimg/");
	define("LOCAL_IMG_PATH",BASE_PATH."img/");
	//define("LOCAL_IMG_PATH",BASE_PATH."img/");
	define("SITE_NAME","crmresellerpanel/");
...
{
	define("BASE_PATH","https://subtech.in/crmpanel/reseller/");
