...
if(!empty($del_id))
{
	$db->exeQuery("delete from am_color where id='".$del_id."' and am_status='Yes'");
	$error="<span class='alert alert-danger'>Data Deleted Successfully</span>";
	header('Refresh:1;url='.BASE_PATH.'All_color/');
}
										...
										<div class="row">
											<div class="col-md-12">
												<div class="card card-box">
													<div class="card-head">
														<header>All Product Color</header>
														
														<div class="btn-group pull-right" style="padding-right:10px;padding-bottom:5px;">
															<a href="<?php echo BASE_PATH;?>Add_color/" id="addRow" class="btn btn-primary">
																Add New Color <i class="fa fa-plus"></i>
															</a>
														</div>
														<div ></div>
													</div>
													<div class="card-body ">
														...
														<div class="table-scrollable">
															<table class="table table-striped table-bordered table-hover table-checkable order-column valign-middle" id="exportTable">
																...
																<tbody>
																<?php 
																	$qr=$db->exeQuery("select * from am_color where am_status='Yes'");
																	$i=1;
																	while($row=$qr->fetch_assoc() )
																	{
																		...
																		<td>
																			<a href="'.BASE_PATH.'Add_color/'.$row['id'].'/" class="btn btn-primary btn-xs">
																				<i class="fa fa-pencil"></i>
																			</a>
																			<a class="btn btn-danger btn-xs" href="'.BASE_PATH.'All_color/'.$row['id'].'/" onclick="return confirm(\'Are You sure to Delete this Record \');">
