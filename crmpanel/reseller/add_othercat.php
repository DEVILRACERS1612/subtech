...
$sql=$db->exeQuery("select * from nt_othercategory where id='".$edit_id."' and nt_status='Yes'");
$row=$sql->fetch_assoc();
...
<html lang="en">
<head>
<title>ADD/EDIT Other Category </title>
				...
				<div class="page-content">
					...
					<div class="row">
						<div class="col-sm-12">
							<div class="card-box">
								<div class="card-head">
									<header>Other Category Information</header>
...
$(document).ready(function(){
	$("#act-form").on("submit",function(e){
		...
		$("#preloader").show();
		$.ajax({
			url:'<?php echo BASE_PATH;?>Controller/OCAT/',
			type:'post',
			...
			success:function(data){
				...
				if(response.type=="success")
				{
					...
					setTimeout(function(){window.location='<?php echo BASE_PATH;?>All_ocat/';},500);
				}
				else
				{
					$("#msg").html(response.message);
