...
if(!empty($del_id))
{
	$db->exeQuery("delete from nt_subcategory where id='".$del_id."' and nt_status='Yes'");
	$error="<span class='alert alert-danger'>Data Deleted Successfully</span>";
	header('Refresh:1;url='.BASE_PATH.'All_subcat/');
}
										...
										<div class="row">
											<div class="col-md-12">
												<div class="card card-box">
													<div class="card-head">
														<header>All Sub Menu </header>
														
														<div class="btn-group pull-right" style="padding-right:10px;padding-bottom:5px;">
															<a href="<?php echo BASE_PATH;?>Add_subcat/" id="addRow" class="btn btn-primary">
																Add New Sub Menu <i class="fa fa-plus"></i>
															</a>
														</div>
														<div ></div>
													</div>
													<div class="card-body ">
														...
														<div class="table-scrollable">
															<table class="table table-striped table-bordered table-hover table-checkable order-column valign-middle" id="exportTable">
																...
																<tbody>
																<?php 
																	$qr=$db->exeQuery("select * from nt_subcategory where nt_status='Yes'");
																	$i=1;
																	while($row=$qr->fetch_assoc() )
																	{
																		...
																		<td>
																			<a href="'.BASE_PATH.'Add_subcat/'.$row['id'].'/" class="btn btn-primary btn-xs">
																				<i class="fa fa-pencil"></i>
																			</a>
																			<a class="btn btn-danger btn-xs" href="'.BASE_PATH.'All_subcat/'.$row['id'].'/" onclick="return confirm(\'Are You sure to Delete this Record \');">
