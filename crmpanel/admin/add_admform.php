...
$q=$db->exeQuery("select * from mi_admform where id='".$edit_id."' ");
$row=$q->fetch_assoc();
...
<html lang="en">
<head>
<title>ADD / EDIT ADMISSION FORM </title>
					...
					<div class="row">
						<div class="col-md-12 col-sm-12">
							<div class="card card-box">
								<div class="card-head">
									<header>New ADMISSION FORM</header>
									...
									<div class="row">
										...
										<div class="col-md-4 col-sm-6">
											<div class="form-group">
												...
												if($row['image']!='')
												{
													echo '<img id="upload1" src="'.WEB_PATH.'school/images/adm_img/'.$row['image'].'" class="img-responsive" />';
												}else{
...
$(document).ready(function(){
	...
	$("#act-form").on("submit",function(e){
		...
		$("#preloader").show();
		$.ajax({
			url:"<?php echo BASE_PATH;?>Controller/ADMFORM/",
			type:'post',
			...
			success:function(data){
				...
				if(response.type=="success")
				{
					...
					setTimeout(function(){window.location='<?php echo BASE_PATH;?>All_Form/';},500);
				}
				else
				{
					$("#msg").html(response.message);
