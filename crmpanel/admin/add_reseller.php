...
$q=$db->exeQuery("select * from mi_reseller where id='".$edit_id."' ");
$row=$q->fetch_assoc();
					...
					<div class="row">
						<div class="col-md-12 col-sm-12">
							<div class="card card-box">
								<div class="card-head">
									<header>New Reseller Registration</header>
									...
									<div class="row">
										<div class="col-md-6 col-sm-6">
											...
											<div class="form-group">
												...
												<input type="text" class="form-control" placeholder="" name="user_name" required value="<?php echo $row['user_name'];?>" />
											</div>
											<div class="form-group">
												<label>Email <span class="text-danger">*</span></label>
												<input type="email" value="<?php echo $row['email'];?>" class="form-control" placeholder="" name="email" />
											</div>
											<div class="form-group">
												<label>Mobile <span class="text-danger">*</span></label>
												<input type="text" value="<?php echo $row['mobile'];?>" class="form-control" placeholder="" name="mobile" required />
											</div>
											<div class="form-group">
												<label>Company name </label>
												<input type="text" value="<?php echo $row['company'];?>" class="form-control" placeholder="" name="company" />
											</div>
																							
											<div class="form-group">
												<label>User_id <span class="text-danger">*</span></label>
												<input type="text" value="<?php echo $row['user_id'];?>" class="form-control" placeholder="" name="user_id" required />
											</div>
											<div class="form-group">
												<label>Password <span class="text-danger">*</span></label>
												<input type="text" value="<?php echo $row1['user_auth'];?>" class="form-control" placeholder="" name="pwd" required />
											</div>
										...
										<div class="col-md-4 col-sm-6">
											<div class="form-group">
												...
												if($row['image']!='')
												{
													echo '<img id="upload1" src="'.RESELLER_PATH.'images/reseller_img/'.$row['image'].'" class="img-responsive" />';
												}else{
										...
										<div class="form-group">
											...
											<div class="form-group">
												...
												<input type="text" value="<?php echo $row['city'];?>" class="form-control" placeholder="" name="city" required>
											</div>
											
											
											<div class="form-group">
												<label>Final Amount <span class="text-danger">*</span></label>
												<input type="text" value="<?php echo $row['amount'];?>" class="form-control" placeholder="" name="amount" required>
											</div>
											<div class="form-group">
											...
											<div class="form-group">
												<label>Annual Renewal Fee.<span class="text-danger">*</span> </label>
												<input type="text" value="<?php echo $row['renew_amt'];?>" class="form-control" placeholder="" name="renew_amt" required />
											</div>
...
$(document).ready(function(){
	...
	$("#act-form").on("submit",function(e){
		...
		$("#preloader").show();
		$.ajax({
			url:"<?php echo BASE_PATH;?>Controller/RESELLER/",
			type:'post',
			...
			success:function(data){
				...
				if(response.type=="success")
				{
					...
					setTimeout(function(){window.location='<?php echo BASE_PATH;?>Manage_Reseller/';},500);
				}
				else
				{
					$("#msg").html(response.message);
