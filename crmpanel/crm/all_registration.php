			...
			<div class="page-content-wrapper">
				<div class="page-content">
					...
					<div class="row">
						...
						<div class="card-box">
						<div class="card-head">
							<header>All Registration </header>
						</div>
						<div class="card-body ">
							<div class="row">
							...
							<div class="table-scrollable">
								<table class="table table-striped table-bordered table-hover table-checkable order-column valign-middle" id="exportTable">
									...
									<?php 
									$qr=$db->exeQuery("select * from mi_registration where mi_status='Yes' order by rdate desc");
									$i=1;
									while($row=$qr->fetch_assoc())
									{
										echo "<tr><td>".$i."</td><td>".date("d M,Y H:i",strtotime($row['rdate']))."</td><td>".$row['lang']."</td><td>".$row['ctype']."</td><td>".$row['cname']."</td><td>".$row['mobile']."</td><td>".$row['state']."</td><td>".$row['city']."</td></tr>";
										$i++;
									}
									?>
									</tbody>
