...
<!DOCTYPE html>
<html lang="en">
	<title>Purchase Stock Item(s) </title>
<head>
			...
			<div class="row">
				<div class="col-md-12">
					<div class="card card-box">
						<div class="card-head">
							<header>All Billing Items</header>
							<div class="btn-group pull-right" style="padding-right:10px; padding-bottom:5px;">
								<a href="<?php echo BASE_PATH;?>Add_Billing/" id="addRow" class="btn btn-primary">
									Billing More Item(s) <i class="fa fa-plus"></i>
								</a>
							</div>
						</div>
						<div class="card-body ">
