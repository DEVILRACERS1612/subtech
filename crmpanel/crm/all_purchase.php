												...
												<div class="card card-box">
													<div class="card-head">
														...
														<div class="btn-group pull-right" style="padding-right:10px; padding-bottom:5px;">
															<a href="<?php echo BASE_PATH;?>Add_Purchase/" id="addRow" class="btn btn-primary">
																Purchase More Item(s) <i class="fa fa-plus"></i>
															</a>
														</div>
													</div>
													<div class="card-body ">
