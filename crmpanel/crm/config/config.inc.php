...
{
	define("MAIN_PATH","http://localhost:8080/crmpanel/");
	define("BASE_PATH","http://localhost:8080/crmpanel/crm/");
	define("WEB_PATH","http://localhost:8080/");
	define("APP_PATH","http://localhost:8080/crmpanel/microerpapp/");
...
else
{
	...
	define("BASE_PATH",$base_url."crmpanel/crm/");
	define("WEB_PATH",$base_url);
	define("MAIN_PATH",$base_url."crmpanel/");
