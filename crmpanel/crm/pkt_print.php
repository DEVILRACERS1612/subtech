...
.product-label25 {
	height: 10mm!important; /* Smaller screen preview width */
	width: 49.5mm!important;
    padding: 0px; /* Reduced padding for screen preview */
    background-color: #fff;
    text-align: center;
    font-size: 20px; /* Smaller font for screen preview */
    line-height: 10mm;
	letter-spacing:1px;
...
.product-label {
    height: 58mm!important; /* Smaller screen preview width */
	width: 49.5mm!important;
...
.product-details-table td {
    padding: 1mm 0.8mm; /* Reduced cell padding */
    border: 1px solid #000;
    text-align: left;
	margin:1mm;
	line-height:.9;
...
.label-section.brand-info .add {
    ...
    .product-details-table td {
        padding: 1mm 0.8mm; /* EXTREMELY SMALL CELL PADDING */
	...
	.product-label25 {
		...
		height: 5mm!important; /* Smaller screen preview width */
		width: 49.5mm!important;
		padding: 0px!important; /* Reduced padding for screen preview */
		background-color: #fff;
		text-align: center;
		font-size: 20px; /* Smaller font for screen preview */
		line-height: 0mm;
...
//print_r($prd);
?>
<table style="height:77mm!important;width:100mm!important;">

<tr style="height:55mm!important">
<td style="width:50mm!important;padding-top:20px;">
	<div class="product-label">
    <div class="label-section brand-info">
        <strong>SUBTECH</strong>
        <div>MFG: S S Power System</div>
        <div class="add">Greater Noida, District : G B Nagar, 201306</div>
    ...
    <table class="product-details-table" style="border:none!important;">
        ...
        <tr>
            <td>MRP</td>
            <td colspan="2"><b>Rs. <?=$prd['mrp']?>/- <span style="font-size:6px">(GST incl of all taxes)</span></b></td>
        </tr>
		<?php if($prd['relay']!=""){ ?>
		<tr>
            <td>Relay</td>
            <td ><?=$prd['relay']?> <?=($prd['inbox'])?'&nbsp; &nbsp; &nbsp;'.$prd['inbox']:''?></td>
        </tr>
		<?php }
		 if($prd['kva']!=""){?>
		<tr>
...
<td style="width:50mm!important;padding-left:20px;padding-top:20px;">
	<div class="product-label">
    <div class="label-section brand-info">
        <strong>SUBTECH</strong>
        <div>MFG: S S Power System</div>
...
<td  style="width:50mm!important;text-align:center;padding-top:20px;">
<div class="product-label25">
<span ><b><?=$row['serial_no']?></b></span>
</div>
</td>
<td style="width:50mm!important;padding-left:20px;padding-top:20px;">
<div class="product-label25">
