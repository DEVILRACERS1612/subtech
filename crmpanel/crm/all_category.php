												...
												<div class="card card-box">
													<div class="card-head">
														...
														<div class="btn-group pull-right" style="padding-right:10px;padding-bottom:5px;">
															<a href="<?php echo BASE_PATH;?>Add_Category/" id="addRow" class="btn btn-primary">
													...
													<div class="card-body ">
														...
														<div class="table-scrollable">
															<table class="table table-striped table-bordered table-hover table-checkable order-column valign-middle" id="exportTable">
																...
																{
																	echo "<tr><td>".$i."</td><td>".$row['cat_name']."</td><td>".$row['description']."</td><td><a href='".BASE_PATH."Add_Category/Edit/".$row['id']."/' class='btn btn-primary btn-xs'><i class='fa fa-pencil'></i></a><a class='btn btn-danger btn-xs delme' data-id='".$row['id']."' data-per='".$page_permission."'><i class='fa fa-trash-o '></i></a></td></tr>";
																	$i++;
																}
																?>
																</tbody>
