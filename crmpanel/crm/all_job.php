			...
			<div class="row">
				<div class="col-md-12">
					<div class="card card-box">
						<div class="card-head">
							<header>All Jobs Detail</header>
							<div class="btn-group pull-right" style="padding-right:10px; padding-bottom:5px;">
								<a href="<?php echo BASE_PATH;?>Add_Job/" id="addRow" class="btn btn-primary">
						...
						<div class="card-body ">
							...
							<div class="table-scrollable">
								...
								<?php
								$qr=$db->exeQuery("select * from mi_job where cmp_id='".$_SESSION[SITE_NAME]['MICMP_cmpid']."'  and mi_status='Yes' order by rdate desc");
								$i=1;
								while($row=$qr->fetch_assoc())
								{
									echo "<tr><td>".$i."</td><td>x</td><td>".$row['job_no']."</td><td>".$row['job_date']."</td><td>".$row['gtotal']."</td><td>".$row['gsubtotal']."</td><td>".$row['nettotal']."</td> <td><!--<a href='".BASE_PATH."Print_Bill/".$row['inv_no']."/' target='_blank' class='btn btn-success btn-xs' title='Print Bill'><i class='fa fa-print'></i></a>--><a href='".BASE_PATH."Add_Job/Edit/".$row['id']."/' class='btn btn-primary btn-xs' title='Edit'><i class='fa fa-pencil'></i></a><a class='btn btn-danger btn-xs delme' data-id='".$row['id']."'  title='Delete'><i class='fa fa-trash-o'></i></a></td></tr>";
									$i++;
								}
									?>
							</tbody>
