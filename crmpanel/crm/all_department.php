					...
					<div class="row">
						<div class="col-md-12">
							<div class="tabbable-line">
								<?php //echo $_SESSION['MISCHOOL_usertype'];?>
												...
												<div class="card card-box">
													<div class="card-head">
														...
														<div class="btn-group pull-right" style="padding-right:10px;padding-bottom:5px;">
															<a href="<?php echo BASE_PATH;?>Add_Department/" id="addRow" class="btn btn-primary">
													...
													<div class="card-body ">
														...
														<div class="table-scrollable">
															<table class="table table-striped table-bordered table-hover table-checkable order-column valign-middle" id="exportTable">
																...
																<?php 
																$qr=$db->exeQuery("select * from mi_department where school_id='".$_SESSION['MISCHOOL_schoolid']."' and mi_status='Yes'");
																
																$i=1;
																while($row=$qr->fetch_assoc())
																{
																	echo "<tr><td>".$i."</td><td>".$row['dep_code']."</td><td>".$row['dep_name']."</td><td>".$row['description']."</td><td><a href='".BASE_PATH."Add_Department/Edit/".$row['id']."/' class='btn btn-primary btn-xs'><i class='fa fa-pencil'></i></a><a class='btn btn-danger btn-xs delme' data-id='".$row['id']."' data-per='".$page_permission."'><i class='fa fa-trash-o '></i></a></td></tr>";
																	$i++;
																}
																?>
																</tbody>
...
$(document).ready(function(){
	...
	$("body").on("click",".delme",function(e){
		...
		$.ajax({
			url:'<?php echo BASE_PATH;?>Controller/DEPARTMENT/',
			method:'post',
			data:datastr,
