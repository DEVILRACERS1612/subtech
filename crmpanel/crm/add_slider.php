...
$sql=$db->exeQuery("select * from mi_slider where id='".$edit_id."' and mi_status='Yes'");
$row=$sql->fetch_assoc();
					...
					<div class="row">
						<div class="col-sm-7">
							<div class="card-box">
								...
								<input type="hidden" name="method" value="Slider" />
							...
							<div class="col-md-12 col-sm-6">
								<div class="form-group">
									<label> Title *</label>
									<input type="text" class="form-control" id="" maxlength="80" name="title" value="<?php echo $row['title'];?>" required />
							...
							<div class="col-md-12 col-sm-6">
								<div class="form-group">
									<label> Link </label>
									<input type="text" class="form-control" name="urlname" value="<?php echo $row['urlname'];?>"  />
							...
							<div class="col-md-12 col-sm-6">
								<div class="form-group">
									...
									<input type="text" class="form-control" maxlength="200" name="subtitle" value="<?php echo $row['subtitle'];?>"/>
								</div>
							</div>
							<div class="col-md-12 col-sm-6">
								<div class="form-group">
							...
							<div class="col-md-2 col-sm-6">
								<div class="form-group">
									...
									if($row['image']!='')
									{
										echo '<img id="upload1" src="'.WEB_PATH.'images/slider_img/'.$row['image'].'" class="img-responsive" />';
									}else{
						...
						<div class="card-body ">
							...
							<div class="table-scrollable">
								<table class="table table-striped table-bordered table-hover table-checkable order-column valign-middle" id="exportTable">
									...
									<?php 
									$qr=$db->exeQuery("select * from mi_slider where  mi_status='Yes'");
									$i=1;
									while($row=$qr->fetch_assoc())
									{
										echo "<tr><td>".$i."</td><td><img src='".WEB_PATH."images/slider_img/".$row['image']."' style='width:100px;' /><br>".$row['title']."</td><td><a href='".BASE_PATH."Add_Slider/Edit/".$row['id']."/' class='btn btn-primary btn-xs'><i class='fa fa-pencil'></i></a><a class='btn btn-danger btn-xs delme' data-id='".$row['id']."'><i class='fa fa-trash-o '></i></a></td></tr>";
										$i++;
									}
									?>
									</tbody>
...
$(document).ready(function(){
	...
	$("body").on("click",".delme",function(e){
		...
		var datastr="post_id=<?php echo $post_id;?>&pg_pmsn="+pgpmsn+"&del_id="+did+"&method=DeleteSlider";
		...
		$.ajax({
			...
			success:function(data){
				...
				if(response.type=="success")
				{
					...
					setTimeout(function(){window.location='<?php echo BASE_PATH;?>Add_Slider';},1500);
				}
				else
				{
					$.toast({
