...
.product-label {
    height: 50mm!important; /* Smaller screen preview width */
	width: 49.5mm!important;
    border: 1px solid #000;
    padding: 5px; /* Reduced padding for screen preview */
    background-color: #fff;
    box-shadow: 1px 1px 5px rgba(0,0,0,0.2); /* Smaller shadow */
    text-align: center;
...
.product-details-table td {
    padding: 2px 5px; /* Reduced cell padding */
    border: 1px solid #000;
    text-align: left;
}
...
<td style="width:50mm!important">
    ...
    <div class="label-section brand-info" style="border-bottom:2px solid #000;font-size:14px;">
	...
	<div class="label-section brand-info" style="border-top:2px solid #000; padding-top:3px; font-size:8.5px;font-weight:bold;">
        <div>IMP./ MKTG. by:Smart Control P L.T.D Iraq </div>
    </div>
	<div class="label-section" style="font-weight:bold;font-size:14px;">
        MAKE IN INDIA
...
<td style="width:50mm!important">
    ...
    <div class="rotate">OK TESTED</div>
